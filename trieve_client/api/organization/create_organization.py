...
from ...models.create_organization_data import CreateOrganizationData
...
def sync_detailed(
    *,
    ...
    Create a new organization. The auth'ed user who creates the organization will be the default owner
    of the organization.
