...
T = TypeVar("T", bound="CreateMessageData")
...
class CreateMessageData:
    r"""
    Attributes:
        new_message_content (str): The content of the user message to attach to the topic and then generate an assistant
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_message_data.additional_properties = d
